...
TEST_CASE("Language:IKey", "[INI]")
{
	...
	const auto VALUES = {Types::Language::Chinese,   Types::Language::English, Types::Language::French,
	                     Types::Language::German,    Types::Language::Italian, Types::Language::Japanese,
	                     Types::Language::Portogese, Types::Language::Russian, Types::Language::Spanish,
	                     Types::Language::Swedish};
...
TEST_CASE("Fullscreen:IKey", "[INI]")
{
	...
	const auto VALUES = {Types::Fullscreen::Disabled, Types::Fullscreen::Enabled};
...
TEST_CASE("SoundVolume:IKey", "[INI]")
{
	...
	const auto VALUES = {Types::SoundVolume::V0,  Types::SoundVolume::V10, Types::SoundVolume::V20,
	                     Types::SoundVolume::V30, Types::SoundVolume::V40, Types::SoundVolume::V50,
	                     Types::SoundVolume::V60, Types::SoundVolume::V70, Types::SoundVolume::V80,
	                     Types::SoundVolume::V90, Types::SoundVolume::V100};
...
TEST_CASE("SoundToggle:IKey", "[INI]")
{
	...
	const auto VALUES = {Types::SoundToggle::Disabled, Types::SoundToggle::Enabled};
...
TEST_CASE("MusicVolume:IKey", "[INI]")
{
	...
	const auto VALUES = {Types::MusicVolume::V0,  Types::MusicVolume::V10, Types::MusicVolume::V20,
	                     Types::MusicVolume::V30, Types::MusicVolume::V40, Types::MusicVolume::V50,
	                     Types::MusicVolume::V60, Types::MusicVolume::V70, Types::MusicVolume::V80,
	                     Types::MusicVolume::V90, Types::MusicVolume::V100};
...
TEST_CASE("MusicToggle:IKey", "[INI]")
{
	...
	const auto VALUES = {Types::MusicToggle::Disabled, Types::MusicToggle::Enabled};
...
TEST_CASE("Castle:IKey", "[INI]")
{
	...
	const auto VALUES = {Types::Castle::Unlocked, Types::Castle::Locked};
...
TEST_CASE("Moon:IKey", "[INI]")
{
	...
	const auto VALUES = {Types::Moon::Unlocked, Types::Moon::Locked};
...
TEST_CASE("Snow:IKey", "[INI]")
{
	...
	const auto VALUES = {Types::Snow::Unlocked, Types::Snow::Locked};
...
TEST_CASE("Desert:IKey", "[INI]")
{
	...
	const auto VALUES = {Types::Desert::Unlocked, Types::Desert::Locked};
...
TEST_CASE("Forest:IKey", "[INI]")
{
	...
	const auto VALUES = {Types::Forest::Unlocked, Types::Forest::Locked};
...
TEST_CASE("Ending:IKey", "[INI]")
{
	...
	const auto VALUES = {Types::Ending::Watched, Types::Ending::Unwatched};
...
TEST_CASE("Intro:IKey", "[INI]")
{
	...
	const auto VALUES = {Types::Intro::Watched, Types::Intro::Unwatched};
...
TEST_CASE("CheatsEnabled:IKey", "[INI]")
{
	...
	const auto VALUES = {Types::CheatsEnabled::Enabled, Types::CheatsEnabled::Disabled};
